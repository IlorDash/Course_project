...
module top (
  ...
  wire         w_4MHz;
  logic [15:0] accel_X;  // X data MSB and LSB from sensor
  logic [15:0] accel_Y;  // Y data MSB and LSB from sensor
  logic [15:0] accel_Z;  // Z data MSB and LSB from sensor
  wire  [14:0] acl_data;
  ...
  assign acl_data = {accel_X[11:7], accel_Y[11:7], accel_Z[11:7]};
